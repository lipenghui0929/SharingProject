...
public class Imsi implements Serializable{
	...
	public Imsi(Integer id, String imei, String imsi, String haoma, String ccid, String sn, String jx, String rjbb,
			String cs, String cmiit, String a, String b, String zc, String struts, String beizhu1, String beizhu2) {
		super();
		this.id = id;
		this.imei = imei;
		this.imsi = imsi;
	...
	public String toString() {
		return "Imsi [id=" + id + ", imei=" + imei + ", imsi=" + imsi + ", haoma=" + haoma + ", ccid=" + ccid + ", sn="
				+ sn + ", jx=" + jx + ", rjbb=" + rjbb + ", cs=" + cs + ", cmiit=" + cmiit + ", a=" + a + ", b=" + b
				+ ", zc=" + zc + ", struts=" + struts + ", beizhu1=" + beizhu1 + ", beizhu2=" + beizhu2 + "]";
	}
